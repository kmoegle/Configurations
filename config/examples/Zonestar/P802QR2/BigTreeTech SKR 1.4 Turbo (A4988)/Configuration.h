...
#define STRING_CONFIG_H_AUTHOR "(gjpc 5-5-2020, SKR V1.4 Turbo)" // Who made the changes.
...
#define TEMP_SENSOR_BED 11    // close match to Zonestar 57 may have to add their file
